  ...
  return (
    <Container>
      <div className="w-full h-[100dvh] flex items-center justify-center flex-col relative">
        ...
        <div className="animate-[bounce_1.8s_ease-in-out_infinite] absolute bottom-4 backdrop-filter backdrop-blur-md bg-white/10 rounded-full flex justify-center items-center border-white/50 border-1 shadow-xl">
